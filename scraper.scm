...
(define basedir "/home/15bx001/lectures/")

(define 6006-url "https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-006-introduction-to-algorithms-fall-2011/lecture-notes/")
(define sicp-url "https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-001-structure-and-interpretation-of-computer-programs-spring-2005/lecture-notes/")
...
(define form-module-hashmap
  (lambda ()
    ...
    (hashq-set! h 'sicp (create-ocw-module sicp-url))
    (hashq-set! h '6006 (create-ocw-module 6006-url))
	h))
